...
class Responsive_Add_Ons {
		...
		<div id="responsive-welcome_banner-section" class="responsive-notice notice">
			<div class="reponsive-welcome_banner-welcome-section">
				<div class="reponsive-welcome_banner-welcome-section-content">
					...
					<a class="responsive-welcome_banner-explore-button" href="<?php echo esc_url( admin_url( 'admin.php?page=responsive-add-ons' ) ); ?>"><?php echo esc_html__( 'Explore Templates', 'responsive-addons' ); ?></a>
				</div>
	...
	public function responsive_ready_sites_register_widget_scripts() {
		wp_enqueue_script( 'responsive-elementor-admin', RESPONSIVE_ADDONS_URI . 'admin/js/responsive-elementor-admin.js', array( 'jquery', 'wp-util', 'updates', 'jquery-ui-autocomplete' ), RESPONSIVE_ADDONS_VER, true );
		...
		$license_msg = sprintf( __( 'This is a Pro Template available with Responsive Pro. you can purchase it from <a href="%s" target="_blank">here</a>.', 'responsive-addons' ), 'https://cyberchimps.com/responsive-go-pro/?utm_source=free-to-pro&utm_medium=responsive-add-ons&utm_campaign=responsive-pro&utm_content=preview-ready-site' );
	...
	public function responsive_add_view_library_btn($links){
		$settings_link = '<a href="' . admin_url( 'admin.php?page=responsive-add-ons' ) . '">' . __( 'View Library', 'responsive-addons' ) . '</a>';
		array_unshift( $links, $settings_link );
		return $links;
	}
			...
			<div style="display: none;" class="responsive-sites-overlay-reveal">
				<div class="responsive-sites-overlay-container">
					...
					<div class="responsive-sites-help-center">
						...
						<a href="https://cyberchimps.com/docs-category/responsive-starter-templates-plugin/" target="_blank" class="responsive-sites-help-center-btn"><?php esc_html_e('Learn More', 'responsive-addons') ?></a>
					</div>
					...
					<div class="responsive-sites-community-support">
						<h3 class="responsive-sites-overlay-heading"><?php esc_html_e('Community Support', 'responsive-addons') ?></h3>
						<p class="responsive-sites-overlay-content"><?php esc_html_e('Find help to the commonly asked questions in our exclusive Community on Facebook.', 'responsive-addons') ?></p>
						<a href="https://www.facebook.com/groups/responsive.theme/" target="_blank" class="responsive-sites-community-support-btn"><?php esc_html_e('Find Help', 'responsive-addons') ?></a>
					</div>
					<div class="responsive-sites-rate-us">
						...
						<p class="responsive-sites-overlay-content"><?php esc_html_e('Lorem ipsum dolor sit amet consectetur. Consequat risus in facilisis ut ut sagittis.', 'responsive-addons') ?></p>
