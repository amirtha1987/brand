...
(function( $ ) {
	...
	ResponsiveSitesAdmin = {
		...
		_bind: function()
		{
			...
			// Site Import events.
			$( document ).on( 'click'                     , '.import-demo-data, .responsive-ready-site-import-free', ResponsiveSitesAdmin._allProcessRun );
		 ...
		 */
		 _isInstallResponsiveThemeChecked: function() {
			$('.responsive-ready-sites-import-button-wrap button').text('Importing...');
			$('.responsive-ready-sites-import-button-wrap button').prop('disabled', true);
			$('.responsive-ready-sites-import-button-wrap button').css('cursor', 'no-drop');
			...
			.done(
				function ( data ) {
					...
					if ( false === data.success ) {
						...
						setTimeout( function () {
							$('.responsive-ready-sites-import-button-wrap button').text('Launch Site');
							$('.responsive-ready-sites-import-button-wrap button').prop('disabled', false);
							$('.responsive-ready-sites-import-button-wrap button').css('cursor', 'pointer');
							$('.responsive-ready-sites-import-button-wrap button').replaceWith('<p><a class="button button-hero" style="border: none;background-color: #28a745;color: white;" href="' + responsiveSitesAdmin.siteURL + '" target="_blank">Launch Site</a></p>')
							$('.responsive-ready-sites-advanced-options h2').text('Site Import Complete');
						}, 8000);
					}
				}
			);
