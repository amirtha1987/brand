<?php
	...
	if($ecommerce_solution_preloader_bg_image != false){
		$ecommerce_solution_custom_css .='.frame{';
			$ecommerce_solution_custom_css .='background: url('.esc_attr($ecommerce_solution_preloader_bg_image).');';
		$ecommerce_solution_custom_css .='}';
	}
	...
	$ecommerce_solution_custom_css .='.primary-navigation ul.children a, .primary-navigation ul.children li a{';
	...
	$ecommerce_solution_custom_css .='.primary-navigation a:hover, .primary-navigation ul.children li a:hover{';
	...
	$ecommerce_solution_custom_css .='.primary-navigation ul.children li a{';
	...
	$ecommerce_solution_custom_css .='.primary-navigation ul.children li a:hover{';
